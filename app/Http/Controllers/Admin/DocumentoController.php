...
use App\Http\Requests\StoreUpdateDocumentoFormRequest;

class DocumentoController extends Controller
{
    protected $repository, $model;
    
    public function __construct(DocumentoRepositoryInterface $repository, Request $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreUpdateDocumentoFormRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreUpdateDocumentoFormRequest $request, $id)
    {
    ...
    /**
     * Mostra o resultado da pesquisa na tabela documentos
     * 
