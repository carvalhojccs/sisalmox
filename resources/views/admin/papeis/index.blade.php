    ...
    <div class="box box-primary">
        <div class="box-body">
            {{ Form::open(['route' => request()->segment(2).'.search','class' => 'form form-inline']) }}
                {{ Form::text('nome',$filters['nome'] ?? '',['placeholder' => 'Nome do papel','class' => 'form-control']) }}
                {{ Form::text('descricao',$filters['descricao'] ?? '',['placeholder' => 'Código do papel','class' => 'form-control']) }}
