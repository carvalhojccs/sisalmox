<div class="form-row">
    <div class="form-group col-md-6">
        {{ Form::label('nome','Armazem') }}
        {{ Form::text('nome',null,['placeholder' => 'Nome do Armazem','class' => 'form-control']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('sigla','Sigla') }}
        {{ Form::text('sigla',null,['placeholder' => 'Sigla do Armazem','class' => 'form-control']) }}
    </div>
</div>
<div class="form-row">
