    ...
    <div class="box box-primary">
        <div class="box-body">
            <div class="form-group">
                {{ Form::label('armazem','Nome do armazem:') }}
                {{ Form::text('armazem',$data->armazem->nome,['class' => 'form-control','disabled']) }}
            </div>
            <div class="form-group">
            <div class="form-group">
                {{ Form::label('nome','Nome do local de armazenagem:') }}
                {{ Form::text('nome',$data->nome,['class' => 'form-control','disabled']) }}
            </div>
            <div class="form-group">
                {{ Form::label('sigla','Sigla do local de armazenagem:') }}
